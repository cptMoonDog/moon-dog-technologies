...
if not(launch_param:haskey("targetApo")) launch_param:add("targetApo", 80000).
{
   ...
   launch_param:add("pOverV0",              75). // Vertical speed at which to start pitchover                        
   launch_param:add("pOverVf",              175).// Vertical speed at which to handoff steering to prograde follower.
