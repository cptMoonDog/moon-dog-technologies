@lazyglobal off.
{
   ...
   steering_functions:add("atmospheric", {
      ...
      if ship:velocity:orbit:mag > 500 and (ship:verticalspeed < 50 and ship:periapsis < ship:body:atm:height/2) and (eta:apoapsis < 10 or eta:apoapsis > ship:orbit:period/2){
