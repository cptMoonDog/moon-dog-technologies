...
///Public functions
   ...
   declare function genStaging {
      if launch_param:haskey("AG1") and not(AG1) and ship:altitude > launch_param["AG1"] {
        AG1 on.
        launch_param:remove("AG1").
      }
      if launch_param:haskey("AG2") and not(AG2) and ship:altitude > launch_param["AG2"] {
        AG2 on.
        launch_param:remove("AG2").
      }
      if launch_param:haskey("AG3") and not(AG3) and ship:altitude > launch_param["AG3"] {
        AG3 on.
        launch_param:remove("AG3").
      }
      if launch_param:haskey("AG4") and not(AG4) and ship:altitude > launch_param["AG4"] {
        AG4 on.
        launch_param:remove("AG4").
      }
      if launch_param:haskey("AG5") and not(AG5) and ship:altitude > launch_param["AG5"] {
        AG5 on.
        launch_param:remove("AG5").
      }
      if launch_param:haskey("AG6") and not(AG6) and ship:altitude > launch_param["AG6"] {
        AG6 on.
        launch_param:remove("AG6").
      }
      if launch_param:haskey("AG7") and not(AG7) and ship:altitude > launch_param["AG7"] {
        AG7 on.
        launch_param:remove("AG7").
      }
      if launch_param:haskey("AG8") and not(AG8) and ship:altitude > launch_param["AG8"] {
        AG8 on.
        launch_param:remove("AG8").
      }
      if launch_param:haskey("AG9") and not(AG9) and ship:altitude > launch_param["AG9"] {
        AG9 on.
        launch_param:remove("AG9").
      }
      if launch_param:haskey("AG10") and not(AG10) and ship:altitude > launch_param["AG10"] {
        AG10 on.
